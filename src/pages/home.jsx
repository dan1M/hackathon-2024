    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>
            Votre tableau de bord pour gérer les cours, les utilisateurs et plus
            encore.
          </p>
          <button
      ...
      <section className="features">
        ...
        <div className="feature-cards">
          <div className="feature-card">
            ...
            <p>
              Suivez et gérez les utilisateurs de la plateforme avec facilité.
            </p>
          </div>
          <div className="feature-card">
            <h3>Suivi des Cours</h3>
            <p>
              Visualisez les volumes horaires de chaque cours avec des
          ...
          <div className="feature-card">
            ...
            <p>
              Consultez les événements à venir et planifiez vos activités
              efficacement.
            </p>
          </div>
        </div>
